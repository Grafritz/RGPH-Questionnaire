<%@ Page Title=" Question Specification Controle" Language="VB" MasterPageFile="~/MasterPages/DashboardCZMasterPage.master"   AutoEventWireup="false"  MaintainScrollPositionOnPostback="true" CodeFile="Frm_QuestionSpecificationControleListing.aspx.vb" Inherits="Frm_QuestionSpecificationControleListing" %>
...
function MenuItemClicked(sender, eventArgs) {
     ...
     var rdGrid = $find("<%=rdgQuestionSpecificationControle.ClientID %>");
    var _id = rdGrid.get_masterTableView().get_dataItems()[listItemIndex].get_element().cells[0].innerHTML
    switch (clickedItemValue) {
        case "Editer":
            ShowAddUpdateForm('Frm_QuestionSpecificationControleADD.aspx?ID=' + _id + '&ACTION=HideMenuHeader', 950, 550); break;
        case "Delete":
            ShowAddUpdateForm('Frm_QuestionSpecificationControleADD.aspx?ID=' + _id + '&ACTION=HideMenuHeader', 950, 550); break;
        default:
            break;
...
function RowDblClick(sender, eventArgs) {
    ...
    var rdGrid = $find("<%=rdgQuestionSpecificationControle.ClientID %>");
    var _id = rdGrid.get_masterTableView().get_dataItems()[listItemIndex].get_element().cells[0].innerHTML
    ShowAddUpdateForm('Frm_QuestionSpecificationControleADD.aspx?ID=' + _id + '&ACTION=HideMenuHeader', 950, 550);
}
...
<telerik:AjaxSetting AjaxControlID="rdgQuestionSpecificationControle">
<UpdatedControls>
 <telerik:AjaxUpdatedControl ControlID="Panel_Msg" LoadingPanelID="RadAjaxLoadingPanel1" />
 <telerik:AjaxUpdatedControl ControlID="rdgQuestionSpecificationControle" LoadingPanelID="RadAjaxLoadingPanel1" />
</UpdatedControls>
</telerik:AjaxSetting>
...
<h3>
    ...
    <asp:Label ID="Label_Titre" runat="server" Text=" Question Specification Controle" /> 
...
<!--<ol class="breadcrumb"> 
    ...
    <li class="active"> Question Specification Controle</li>
</ol> -->
</section> 
...
<asp:LinkButton ID="Btn_ADD_QuestionSpecificationControle" runat="server" CssClass="btn btn-primary" CausesValidation="false">
    <i class="fa fa-plus-circle" ></i>  Ajouter  Question Specification Controle
</asp:LinkButton>
<span class="pull-right box-tools">
 ...
 <telerik:RadGrid ID="rdgQuestionSpecificationControle" AllowPaging="True" AllowSorting="True" PageSize="20"
...
<telerik:GridBoundColumn DataField="CodeQuestionSTR" UniqueName="CodeQuestion" HeaderText=" Code Question"
