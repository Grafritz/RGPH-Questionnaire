...
Partial Class Frm_QuestionSpecificationControleADD
...
#Region "ATTRIBUTS"
    ...
    Private Const Nom_page As String = "PAGE-FORMULAIRE-QUESTIONSPECIFICATIONCONTROLE"  ' POUR LA PAGE
...
#Region "Load DATA"
    ...
    Private Sub FillCombo_CodeQuestion()
        Try
            Dim objs1 As List(Of Cls_CodeQuestion) = Cls_CodeQuestion.SearchAll
            With DDL_CodeQuestion
                .DataSource = objs1
                .DataValueField = "ID"
                .DataTextField = "CodeQuestion"
                .DataBind()
