<%@ Page Title=" Question Specification Controle" Language="VB" MasterPageFile="~/MasterPages/DashboardCZMasterPage.master"  AutoEventWireup="false" CodeFile="Frm_QuestionSpecificationControleADD.aspx.vb" Inherits="Frm_QuestionSpecificationControleADD"  MaintainScrollPositionOnPostback="true" %>
...
<div class="col-sm-6">
   ...
   <div class="form-group">
<label class="col-sm-3 control-label">Controles
...
<div class="col-sm-6">
   <asp:TextBox ID="txt_Controles" CssClass="form-control" Width="100%" runat="server" placeholder="Controles..."></asp:TextBox>
</div>
...
<div class="col-sm-6">
   <asp:TextBox ID="txt_Messages" CssClass="form-control" Width="100%" runat="server" placeholder="Messages..."></asp:TextBox>
</div>
