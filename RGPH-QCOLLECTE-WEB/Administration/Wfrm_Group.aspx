<%@ Page Title=".:: Sécurité - Groupe Utilisateur ::." Language="VB" MasterPageFile="~/MasterPages/MasterPage_Security.master"
    AutoEventWireup="false" CodeFile="Wfrm_Group.aspx.vb" Inherits="Parametres_Administration_Wfrm_Group" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <section class="content-header">
        <h1>
            <asp:Label ID="Label_Utilisateur" runat="server" Text="GROUPE UTILISATEURS " />
            <small> <asp:Label ID="LabelNumeroDeReference" runat="server" /></small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Accueil</a></li>
            <li class="active">Groupe Utilisateurs</li>
        </ol>
     </section>
                        ...
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td class="TextAlignRight" style="text-align:right;">
                                    <asp:Label ID="Label1" runat="server" Text="Description Groupe :"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txt_ID" runat="server" Visible="false" Width="0px" />
                                    <asp:TextBox ID="txt_Description_Groupe" runat="server" CssClass="TextField" Width="333px" />
                                    <asp:RequiredFieldValidator runat="server" ID="NREG_DDL_txt_Description_Groupe" ControlToValidate="txt_Description_Groupe"
                                        Text="*" ErrorMessage="Description Groupe obligatoire" ValidationGroup="GPSave" />
                                </td>
                            </tr>
                            <tr>
                                <td class="TextAlignRight" style="text-align:right;">
                                    <asp:Label ID="Label2" runat="server" Text="Page par default :"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txt_PageDefault" runat="server" CssClass="TextField" Width="333px" />
                                    <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="txt_PageDefault"
                                        Text="*" ErrorMessage="Page Groupe obligatoire" ValidationGroup="GPSave" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="GridView_List" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="#" HeaderStyle-Width="16" >
                                                <ItemTemplate>
                                                    <asp:Label ID="lbOrder" runat="server"></asp:Label>
                                                    <asp:Label ID="lbID" runat="server" Text='<%# Bind("ID") %>' Visible="false"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField ReadOnly="true"  DataField="ID" HeaderText="Code"  HeaderStyle-Width="16"  />
                                            <asp:BoundField ReadOnly="true" DataField="GROUPE_DESCRIPTION" HeaderText="Nom Groupe" SortExpression="GROUPE_DESCRIPTION" />
                                            <asp:BoundField ReadOnly="true" DataField="PageDefault" HeaderText="Page Default" SortExpression="PageDefault" />
