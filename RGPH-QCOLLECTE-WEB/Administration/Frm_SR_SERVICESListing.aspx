<%@ Page Title="Rezo509 | Produits / SERVICES" Language="VB" MasterPageFile="~/MasterPages/MasterPage_Security.master" AutoEventWireup="false" MaintainScrollPositionOnPostback="true" CodeFile="Frm_SR_SERVICESListing.aspx.vb" Inherits="Frm_SR_SERVICESListing" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="rdgSR_SERVICES">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="Panel_Msg" LoadingPanelID="RadAjaxLoadingPanel1" />
                    <telerik:AjaxUpdatedControl ControlID="rdgSR_SERVICES" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
    ...
    <section class="content">
        <asp:Panel ID="Panel_First" runat="server" CssClass="panel panel-default panel-body">
                        <asp:LinkButton ID="rbtnAddSR_SERVICES" runat="server" CssClass="btn btn-primary" Style="margin-bottom: 5px;">
                <i class="fa fa-plus-square-o"></i> Ajouter Services </asp:LinkButton>
            <telerik:RadGrid ID="rdgSR_SERVICES" AllowPaging="True" AllowSorting="True" PageSize="20"
                ...
                <MasterTableView CommandItemDisplay="None" GridLines="None" DataKeyNames="ID" NoDetailRecordsText="Pas d'enregistrement"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="NomService" UniqueName="NomService" HeaderText=" Nom Service"
                            FilterControlAltText="Filter NomService column" FilterControlWidth="95%" ShowFilterIcon="false"
                            AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="DescriptionService" UniqueName="DescriptionService" HeaderText=" Description Service"
                            FilterControlAltText="Filter DescriptionService column" FilterControlWidth="95%" ShowFilterIcon="false"
                            AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="delete" DataTextField="ID"
                            ...
                            UniqueName="delete" HeaderText="" ConfirmDialogType="RadWindow" ConfirmText="Voulez-vous vraiment supprimer ce SR_SERVICES?"
