...
REM Date:1/18/2018 11:38:27 AM
Imports Microsoft
Imports System.Data
...
Partial Class Frm_ContrainteADD
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Is_Acces_Page Then
            If Not IsPostBack Then
                ...
                'rbtnAddContrainte.Attributes.Add("onclick", "javascript:void(ShowAddUpdateForm('Frm_ContrainteADD.aspx', 950, 650)); return false;")
                'BtnADDNew.Attributes.Add("onclick", "javascript:Open_Window('Frm_ContrainteADD.aspx', '_self',500,400); return false;") 
                LOAD_ALL_DATA()
            End If
        End If
    End Sub
        ...
        Try
            If Request.QueryString("ID") IsNot Nothing Then
                ...
                If obj.ID > 0 Then
                    ...
                    With obj
                        txt_Code.Text = .Code
                        txt_Contrainte.Text = .Contrainte
                    End With
                End If
            Else
...
#Region "METHODES - SAVE"
    Private Sub SAVE_CONTRAINTE()
        Try
            Dim _id As Long = TypeSafeConversion.NullSafeLong(txt_CodeContrainte_Hid.Text)
            Dim obj As New Cls_Contrainte(_id)
            With obj
                .Code = txt_Code.Text
                .Contrainte = txt_Contrainte.Text
            End With
            obj.Save(User_Connected.Username)
            REM TRACE UTILUSATEUR / Trace Transaction
            User_Connected.Activite_Utilisateur_InRezo(IIf(_id <= 0, "ADD ", "EDIT ") & " Contrainte", obj.LogData(obj), Request.UserHostAddress)
            txt_CodeContrainte_Hid.Text = obj.ID
            '_message = "Sauvegarde Effectuée"
            MessageToShow([Global].Msg_Enregistrement_Effectue, "S", False)
            'RadAjaxManager1.ResponseScripts.Add("CloseAndRefreshListeContrainte();")
