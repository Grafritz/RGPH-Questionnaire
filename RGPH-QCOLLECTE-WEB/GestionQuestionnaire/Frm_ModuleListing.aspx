<%@ Page Title=" Module" Language="VB" MasterPageFile="~/MasterPages/DashboardCZMasterPage.master" AutoEventWireup="false" MaintainScrollPositionOnPostback="true" CodeFile="Frm_ModuleListing.aspx.vb" Inherits="Frm_ModuleListing" %>
...
function RowContextMenu(sender, eventArgs) {
 ...
 function RowDblClick(sender, eventArgs) {
     ...
     var rdGrid = $find("<%=rdgModule.ClientID %>");
    var _id = rdGrid.get_masterTableView().get_dataItems()[listItemIndex].get_element().cells[0].innerHTML
    ShowAddUpdateForm('Frm_ModuleADD.aspx?ID=' + _id + '&ACTION=HideMenuHeader', 950, 550);
}
...
function GetRadWindow() {
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="rdgModule">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="Panel_Msg" LoadingPanelID="RadAjaxLoadingPanel1" />
                    <telerik:AjaxUpdatedControl ControlID="rdgModule" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        ...
        <div class="mail-inbox">
            <section class="page-head" id="PageHeader" runat="server">
                <h3>
                    ...
                    <asp:Label ID="Label_Titre" runat="server" Text=" Module" />
    ...
    <li class="active"> Module</li>
            ...
            <section class="content">
                ...
                <asp:Panel runat="server" ID="Panel_First" Style="margin: 5px;">
                    <asp:LinkButton ID="Btn_ADD_Module" runat="server" CssClass="btn btn-primary" CausesValidation="false">
    <i class="fa fa-plus-circle" ></i>  Ajouter  Module
                    </asp:LinkButton>
        ...
        <i class="fa fa-ban on fa-filter" ></i> Clear Filters
                    ...
                    <telerik:RadGrid ID="rdgModule" AllowPaging="True" AllowSorting="True" PageSize="20"
                        ...
                        <MasterTableView CommandItemDisplay="Top" GridLines="None" DataKeyNames="ID" NoDetailRecordsText="Pas d'enregistrement"
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="CodeModule" UniqueName="CodeModule" HeaderText=" Code Module"
                                    FilterControlAltText="Filter CodeModule column" FilterControlWidth="95%" ShowFilterIcon="false"
                                    AllowFiltering="true" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="NomModule" UniqueName="NomModule" HeaderText=" Nom Module"
                                    FilterControlAltText="Filter NomModule column" FilterControlWidth="95%" ShowFilterIcon="false"
                                    AllowFiltering="true" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="TypeModuleSTR" UniqueName="TypeModule" HeaderText=" Type Module"
                                    FilterControlAltText="Recherche par  Type Module" FilterControlWidth="95%" ShowFilterIcon="false"
                                    AllowFiltering="true" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="Description" UniqueName="Description" HeaderText=" Description"
                                    FilterControlAltText="Filter Description column" FilterControlWidth="95%" ShowFilterIcon="false"
                                    AllowFiltering="true" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                </telerik:GridBoundColumn>
                                <telerik:GridTemplateColumn DataField="EstActif" UniqueName="EstActif" HeaderText=" Est Actif" ShowFilterIcon="false" AllowFiltering="false" >
                                    <ItemTemplate>
                                        <asp:Image ID="Image_EstActif" runat="server" ImageUrl='<%#Bind("EstActif_Image") %>' />
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" Width="16px" />
                                    <ItemStyle HorizontalAlign="Center" Width="16px" />
                                </telerik:GridTemplateColumn>
