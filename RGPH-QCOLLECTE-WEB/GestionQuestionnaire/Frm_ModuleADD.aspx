<%@ Page Title=" Module" Language="VB" MasterPageFile="~/MasterPages/DashboardCZMasterPage.master" AutoEventWireup="false" CodeFile="Frm_ModuleADD.aspx.vb" Inherits="Frm_ModuleADD" MaintainScrollPositionOnPostback="true" %>
                    ...
                    <div id="DIV_Panel" class="form-horizontal group-border-dashed1" style="border-radius: 0px;">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">
                                Code Module
   <asp:RequiredFieldValidator ID="RFV_CodeModule" runat="server" ControlToValidate="txt_CodeModule"
       ErrorMessage="Code Module Obligatoire !" SetFocusOnError="true" Display="Dynamic" Text="*"
       ValidationGroup="GPSave" CssClass="text-danger" />
                            </label>
                            <div class="col-sm-6">
                                <asp:TextBox ID="txt_CodeModule" CssClass="form-control" Width="100%" runat="server" placeholder="Code Module..."></asp:TextBox>
                            </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">
                                Nom Module
   <asp:RequiredFieldValidator ID="RFV_NomModule" runat="server" ControlToValidate="txt_NomModule"
       ErrorMessage="Nom Module Obligatoire !" SetFocusOnError="true" Display="Dynamic" Text="*"
       ValidationGroup="GPSave" CssClass="text-danger" />
                            </label>
                            <div class="col-sm-6">
                                <asp:TextBox ID="txt_NomModule" CssClass="form-control" Width="100%" runat="server" placeholder="Nom Module..."></asp:TextBox>
                            </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">
                                Description
   <asp:RequiredFieldValidator ID="RFV_Description" runat="server" ControlToValidate="txt_Description"
       ErrorMessage="Description Obligatoire !" SetFocusOnError="true" Display="Dynamic" Text="*"
       ValidationGroup="GPSave" CssClass="text-danger" />
                            </label>
                            <div class="col-sm-6">
                                <asp:TextBox ID="txt_Description" CssClass="form-control" Width="100%" runat="server" placeholder="Description..."></asp:TextBox>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <label>
                                    <asp:CheckBox ID="CB_EstActif" runat="server" Text="EstActif" /></label>
                            </div>
    ...
    <asp:LinkButton ID="Btn_Annuler" CausesValidation="false" runat="server" CssClass="btn btn-danger">
        <i class="fa  fa-reply-all" ></i> Annuler
                ...
                <asp:TextBox ID="txt_CodeModule_Hid" runat="server" Text="0" Visible="False" Width="1px"></asp:TextBox>
            </section>
