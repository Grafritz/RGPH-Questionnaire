...
REM Date:1/17/2018 10:50:40 AM
Imports Microsoft
Imports System.Data
...
Partial Class Frm_TypeModuleADD
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Is_Acces_Page Then
            If Not IsPostBack Then
                ...
                'rbtnAddTypeModule.Attributes.Add("onclick", "javascript:void(ShowAddUpdateForm('Frm_TypeModuleADD.aspx', 950, 650)); return false;")
                'BtnADDNew.Attributes.Add("onclick", "javascript:Open_Window('Frm_TypeModuleADD.aspx', '_self',500,400); return false;") 
                LOAD_ALL_DATA()
            End If
        End If
    End Sub
        ...
        Try
            If Request.QueryString("ID") IsNot Nothing Then
                ...
                If obj.ID > 0 Then
                    ...
                    With obj
                        txt_TypeModule.Text = .TypeModule
                    End With
                End If
            Else
...
#Region "METHODES - SAVE"
    Private Sub SAVE_TYPEMODULE()
        Try
            Dim _id As Long = TypeSafeConversion.NullSafeLong(txt_CodeTypeModule_Hid.Text)
            Dim obj As New Cls_TypeModule(_id)
            With obj
                .TypeModule = txt_TypeModule.Text
            End With
            obj.Save(User_Connected.Username)
            REM TRACE UTILUSATEUR / Trace Transaction
            User_Connected.Activite_Utilisateur_InRezo(IIf(_id <= 0, "ADD ", "EDIT ") & " TypeModule", obj.LogData(obj), Request.UserHostAddress)
            txt_CodeTypeModule_Hid.Text = obj.ID
            '_message = "Sauvegarde Effectuée"
            MessageToShow([Global].Msg_Enregistrement_Effectue, "S", False)
            'RadAjaxManager1.ResponseScripts.Add("CloseAndRefreshListeTypeModule();")
