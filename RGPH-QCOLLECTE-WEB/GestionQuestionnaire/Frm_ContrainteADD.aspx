<%@ Page Title=" Contrainte" Language="VB" MasterPageFile="~/MasterPages/DashboardCZMasterPage.master"  AutoEventWireup="false" CodeFile="Frm_ContrainteADD.aspx.vb" Inherits="Frm_ContrainteADD"  MaintainScrollPositionOnPostback="true" %>
...
<label class="col-sm-3 control-label">Code
   <asp:RequiredFieldValidator  ID="RFV_Code" runat="server" ControlToValidate="txt_Code"  
       ErrorMessage="Code Obligatoire !" SetFocusOnError="true" Display="Dynamic" Text="*" 
       ValidationGroup="GPSave" CssClass="text-danger" /> 
</label>
<div class="col-sm-6">
   <asp:TextBox ID="txt_Code" CssClass="form-control" Width="100%" runat="server" placeholder="Code..."></asp:TextBox>
</div>

 </div>
   <div class="form-group">
<label class="col-sm-3 control-label">Contrainte
   <asp:RequiredFieldValidator  ID="RFV_Contrainte" runat="server" ControlToValidate="txt_Contrainte"  
       ErrorMessage="Contrainte Obligatoire !" SetFocusOnError="true" Display="Dynamic" Text="*" 
       ValidationGroup="GPSave" CssClass="text-danger" /> 
</label>
<div class="col-sm-6">
   <asp:TextBox ID="txt_Contrainte" CssClass="form-control" Width="100%" runat="server" placeholder="Contrainte..."></asp:TextBox>
</div>
...
<asp:TextBox ID="txt_CodeContrainte_Hid" runat="server" Text="0" Visible="False" Width="1px"></asp:TextBox>
</section>
