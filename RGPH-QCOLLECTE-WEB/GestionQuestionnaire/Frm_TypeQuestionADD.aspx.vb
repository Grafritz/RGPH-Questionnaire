...
REM Date:1/18/2018 12:14:00 PM
Imports Microsoft
Imports System.Data
...
Partial Class Frm_TypeQuestionADD
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Is_Acces_Page Then
            If Not IsPostBack Then
                ...
                'rbtnAddTypeQuestion.Attributes.Add("onclick", "javascript:void(ShowAddUpdateForm('Frm_TypeQuestionADD.aspx', 950, 650)); return false;")
                'BtnADDNew.Attributes.Add("onclick", "javascript:Open_Window('Frm_TypeQuestionADD.aspx', '_self',500,400); return false;") 
                LOAD_ALL_DATA()
            End If
        End If
    End Sub
...
#Region "METHODES - SAVE"
    Private Sub SAVE_TYPEQUESTION()
        Try
            Dim _id As Long = TypeSafeConversion.NullSafeLong(txt_CodeTypeQuestion_Hid.Text)
            Dim obj As New Cls_TypeQuestion(_id)
            With obj
            ...
            User_Connected.Activite_Utilisateur_InRezo(IIf(_id <= 0, "ADD ", "EDIT ") & " TypeQuestion", obj.LogData(obj), Request.UserHostAddress)
            txt_CodeTypeQuestion_Hid.Text = obj.ID
            '_message = "Sauvegarde Effectuée"
            MessageToShow([Global].Msg_Enregistrement_Effectue, "S", False)
            'RadAjaxManager1.ResponseScripts.Add("CloseAndRefreshListeTypeQuestion();")
