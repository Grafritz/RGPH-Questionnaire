<%@ Page Title=" Contrainte" Language="VB" MasterPageFile="~/MasterPages/DashboardCZMasterPage.master" AutoEventWireup="false" MaintainScrollPositionOnPostback="true" CodeFile="Frm_ContrainteListing.aspx.vb" Inherits="Frm_ContrainteListing" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function MenuItemClicked(sender, eventArgs) {
                ...
                var rdGrid = $find("<%=rdgContrainte.ClientID %>");
                var _id = rdGrid.get_masterTableView().get_dataItems()[listItemIndex].get_element().cells[0].innerHTML
                switch (clickedItemValue) {
                    case "Editer":
                        ShowAddUpdateForm('Frm_ContrainteADD.aspx?ID=' + _id + '&ACTION=HideMenuHeader', 950, 550); break;
                    case "Delete":
                        ShowAddUpdateForm('Frm_ContrainteADD.aspx?ID=' + _id + '&ACTION=HideMenuHeader', 950, 550); break;
                    default:
                        break;
            ...
            function RowDblClick(sender, eventArgs) {
                ...
                var rdGrid = $find("<%=rdgContrainte.ClientID %>");
                var _id = rdGrid.get_masterTableView().get_dataItems()[listItemIndex].get_element().cells[0].innerHTML
                ShowAddUpdateForm('Frm_ContrainteADD.aspx?ID=' + _id + '&ACTION=HideMenuHeader', 950, 550);
            }
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="rdgContrainte">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="Panel_Msg" LoadingPanelID="RadAjaxLoadingPanel1" />
                    <telerik:AjaxUpdatedControl ControlID="rdgContrainte" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        ...
        <div class="mail-inbox">
            <section class="page-head" id="PageHeader" runat="server">
                <h3>
                    ...
                    <asp:Label ID="Label_Titre" runat="server" Text=" Contrainte" />
    ...
    <li class="active"> Contrainte</li>
            ...
            <section class="content">
                ...
                <asp:Panel runat="server" ID="Panel_First" Style="margin: 5px;">
                    <asp:LinkButton ID="Btn_ADD_Contrainte" runat="server" CssClass="btn btn-primary" CausesValidation="false">
    <i class="fa fa-plus-circle" ></i>  Ajouter  Contrainte
                    </asp:LinkButton>
        ...
        <i class="fa fa-ban on fa-filter" ></i> Clear Filters
                    ...
                    <telerik:RadGrid ID="rdgContrainte" AllowPaging="True" AllowSorting="True" PageSize="20"
                        ...
                        <MasterTableView CommandItemDisplay="Top" GridLines="None" DataKeyNames="ID" NoDetailRecordsText="Pas d'enregistrement"
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="Code" UniqueName="Code" HeaderText=" Code"
                                    FilterControlAltText="Filter Code column" FilterControlWidth="95%" ShowFilterIcon="false"
                                    AllowFiltering="true" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                    <HeaderStyle HorizontalAlign="Center" Width="16px" />
                                    <ItemStyle HorizontalAlign="Center" Width="16px" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="Contrainte" UniqueName="Contrainte" HeaderText=" Contrainte"
                                    FilterControlAltText="Filter Contrainte column" FilterControlWidth="95%" ShowFilterIcon="false"
                                    AllowFiltering="true" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                </telerik:GridBoundColumn>
