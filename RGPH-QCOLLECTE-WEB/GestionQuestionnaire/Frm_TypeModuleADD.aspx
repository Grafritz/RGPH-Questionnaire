<%@ Page Title=" Type Module" Language="VB" MasterPageFile="~/MasterPages/DashboardCZMasterPage.master"  AutoEventWireup="false" CodeFile="Frm_TypeModuleADD.aspx.vb" Inherits="Frm_TypeModuleADD"  MaintainScrollPositionOnPostback="true" %>
...
<h3>
    ...
    <asp:Label ID="Label_Titre" runat="server" Text="TypeModule" /> 
...
<label class="col-sm-3 control-label">Type Module
   <asp:RequiredFieldValidator  ID="RFV_TypeModule" runat="server" ControlToValidate="txt_TypeModule"  
       ErrorMessage="Type Module Obligatoire !" SetFocusOnError="true" Display="Dynamic" Text="*" 
       ValidationGroup="GPSave" CssClass="text-danger" /> 
</label>
<div class="col-sm-6">
   <asp:TextBox ID="txt_TypeModule" CssClass="form-control" Width="100%" runat="server" placeholder="Type Module..."></asp:TextBox>
</div>
...
<asp:TextBox ID="txt_CodeTypeModule_Hid" runat="server" Text="0" Visible="False" Width="1px"></asp:TextBox>
</section>
