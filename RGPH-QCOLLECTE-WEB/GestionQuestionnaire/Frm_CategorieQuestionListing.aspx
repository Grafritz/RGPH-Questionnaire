<%@ Page Title=" Categorie Question" Language="VB" MasterPageFile="~/MasterPages/DashboardCZMasterPage.master" AutoEventWireup="false" MaintainScrollPositionOnPostback="true" CodeFile="Frm_CategorieQuestionListing.aspx.vb" Inherits="Frm_CategorieQuestionListing" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function MenuItemClicked(sender, eventArgs) {
                ...
                var rdGrid = $find("<%=rdgCategorieQuestion.ClientID %>");
    var _id = rdGrid.get_masterTableView().get_dataItems()[listItemIndex].get_element().cells[0].innerHTML
    switch (clickedItemValue) {
        case "Editer":
            ShowAddUpdateForm('Frm_CategorieQuestionADD.aspx?ID=' + _id + '&ACTION=HideMenuHeader', 950, 550); break;
        case "Delete":
            ShowAddUpdateForm('Frm_CategorieQuestionADD.aspx?ID=' + _id + '&ACTION=HideMenuHeader', 950, 550); break;
        default:
            break;
...
function RowContextMenu(sender, eventArgs) {
 ...
 function RowDblClick(sender, eventArgs) {
     ...
     var rdGrid = $find("<%=rdgCategorieQuestion.ClientID %>");
    var _id = rdGrid.get_masterTableView().get_dataItems()[listItemIndex].get_element().cells[0].innerHTML
    ShowAddUpdateForm('Frm_CategorieQuestionADD.aspx?ID=' + _id + '&ACTION=HideMenuHeader', 950, 550);
}
...
function GetRadWindow() {
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="rdgCategorieQuestion">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="Panel_Msg" LoadingPanelID="RadAjaxLoadingPanel1" />
                    <telerik:AjaxUpdatedControl ControlID="rdgCategorieQuestion" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        ...
        <div class="mail-inbox">
            <section class="page-head" id="PageHeader" runat="server">
                <h3>
                    ...
                    <asp:Label ID="Label_Titre" runat="server" Text=" Categorie Question" />
    ...
    <li class="active"> Categorie Question</li>
</ol> -->
            </section>
            <section class="content">
                ...
                <asp:Panel runat="server" ID="Panel_First" Style="margin: 5px;">
                    <asp:LinkButton ID="Btn_ADD_CategorieQuestion" runat="server" CssClass="btn btn-primary" CausesValidation="false">
    <i class="fa fa-plus-circle" ></i>  Ajouter  Categorie Question
                    </asp:LinkButton>
        ...
        <i class="fa fa-ban on fa-filter" ></i> Clear Filters
                    ...
                    <telerik:RadGrid ID="rdgCategorieQuestion" AllowPaging="True" AllowSorting="True" PageSize="20"
                        ...
                        <MasterTableView CommandItemDisplay="Top" GridLines="None" DataKeyNames="ID" NoDetailRecordsText="Pas d'enregistrement"
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="CodeCategorie" UniqueName="CodeCategorie" HeaderText=" Code Categorie"
                                    FilterControlAltText="Filter CodeCategorie column" FilterControlWidth="95%" ShowFilterIcon="false"
                                    AllowFiltering="true" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="CategorieQuestion" UniqueName="CategorieQuestion" HeaderText=" Categorie Question"
                                    FilterControlAltText="Filter CategorieQuestion column" FilterControlWidth="95%" ShowFilterIcon="false"
                                    AllowFiltering="true" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="DetailsCategorie" UniqueName="DetailsCategorie" HeaderText=" Details Categorie"
                                    FilterControlAltText="Filter DetailsCategorie column" FilterControlWidth="95%" ShowFilterIcon="false"
                                    AllowFiltering="true" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="SousDetailsCategorie" UniqueName="SousDetailsCategorie" HeaderText=" Sous Details Categorie"
                                    FilterControlAltText="Filter SousDetailsCategorie column" FilterControlWidth="95%" ShowFilterIcon="false"
                                    AllowFiltering="true" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                </telerik:GridBoundColumn>
