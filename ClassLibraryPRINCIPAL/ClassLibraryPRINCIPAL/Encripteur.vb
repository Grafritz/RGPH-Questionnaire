...
Public Class Encripteur
    ...
    Public Shared Function EncryptMD5(input As String) As String
        Dim md5__1 As MD5 = MD5.Create()
        Dim inputBytes As Byte() = System.Text.ASCIIEncoding.ASCII.GetBytes(input)
...
#Region "Decrypt"
    Public Function Decrypt_Fritz(ByVal input As String) As String
        Dim rText As String = ""
        Dim i As Integer = 0
        Dim sLen As Integer = 0
        Dim bInput() As Byte
    ...
    Public Function Decrypt(ByVal input As String) As String
        Dim bInput() As Byte
        Dim bResulB() As Byte
        Dim bResulS As String

        Try
            bInput = Convert.FromBase64String(input)
            bResulB = Decrypt(bInput)
            bResulS = Convert.ToString(System.Text.ASCIIEncoding.ASCII.GetString(bResulB))
            bResulS = Trim(bResulS.Replace(Chr(Nothing), ""))
